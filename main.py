...
@app.get('/sort')
def sort_patient(sort_by:str = Query(..., description='Sort on the basis of height, weighth or bmi'),
    ...
    if order not in ['asc', 'desc']:
        raise HTTPException(status_code=400, detail='Invaid order select between asc and desc')
...
def delete_patient(patinet_id: str):
